namespace unlockfps
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            InputFPS.Maximum = new decimal(new int[] { Int32.MaxValue, 0, 0, 0 });
            ...
            ToolTipMain.SetToolTip(CBAutoStart, "这会在下一次启动时生效");
            CBAutoStart.UseVisualStyleBackColor = true;
            // 
            // BtnStartGame
            // 
            BtnStartGame.Location = new Point(310, 138);
            BtnStartGame.Margin = new Padding(5, 5, 5, 5);
            BtnStartGame.Name = "BtnStartGame";
            BtnStartGame.Size = new Size(118, 37);
            ...
            ContextNotify.Size = new Size(177, 64);
            // 
            // StartGameMenuItem
            // 
            StartGameMenuItem.Name = "StartGameMenuItem";
            StartGameMenuItem.Size = new Size(176, 30);
            StartGameMenuItem.Text = "启动游戏";
            StartGameMenuItem.Click += StartGameMenuItem_Click;
            // 
            // ExitMenuItem
            // 
            ExitMenuItem.Name = "ExitMenuItem";
            ExitMenuItem.Size = new Size(176, 30);
