namespace unlockfps
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            LabelAutoSave.Font = new Font("Microsoft YaHei UI", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            LabelAutoSave.Location = new Point(19, 14);
            LabelAutoSave.Margin = new Padding(5, 0, 5, 0);
            LabelAutoSave.Name = "LabelAutoSave";
            LabelAutoSave.Size = new Size(192, 25);
            ...
            // 
            CBHdr.AutoSize = true;
            CBHdr.Location = new Point(9, 130);
            CBHdr.Margin = new Padding(5);
            CBHdr.Name = "CBHdr";
            CBHdr.Size = new Size(117, 28);
            CBHdr.TabIndex = 6;
            CBHdr.Text = "启用 HDR";
            ...
            ComboPriority.Location = new Point(196, 163);
            ...
            LabelPriority.Location = new Point(5, 168);
            ...
            CBPowerSave.Size = new Size(72, 28);
            CBPowerSave.TabIndex = 3;
            CBPowerSave.Text = "节能";
            ToolTipSettings.SetToolTip(CBPowerSave, "在失去焦点时将 FPS 设为 10（如在游戏外单击）\r\n");
            ...
            ToolTipSettings.SetToolTip(CBAutoClose, "解锁器会在游戏退出时退出");
            ...
            CBStartMinimized.Size = new Size(234, 28);
            CBStartMinimized.TabIndex = 1;
            CBStartMinimized.Text = "启动时最小化（解锁器）";
            ToolTipSettings.SetToolTip(CBStartMinimized, "启动器会在游戏启动后隐藏");
            ...
            CBUseMobileUI.Size = new Size(149, 28);
            CBUseMobileUI.TabIndex = 11;
            CBUseMobileUI.Text = "启用移动端 UI";
            ...
            LabelMonitor.Size = new Size(64, 24);
            ...
            CBSuspendLoad.Size = new Size(157, 28);
            CBSuspendLoad.TabIndex = 4;
            CBSuspendLoad.Text = "加载时挂起";
            ToolTipSettings.SetToolTip(CBSuspendLoad, "这可以保证所有 DLL 都在游戏启动前加载\r\n这可能不总是有效\r\n如果游戏崩溃，取消此选项");
